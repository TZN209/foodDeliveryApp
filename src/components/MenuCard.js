...
const styles = StyleSheet.create({
    view1: { backgroundColor: 'white', elevation: 4, shadowOpacity: 0.4, shadowColor: 'black', margin: 5, padding: 10 },
    view2: { flex: 1, flexDirection: 'row', padding: 0, justifyContent: 'space-between' },
