...
const styles = StyleSheet.create({
    ...
    view2: { justifyContent: 'flex-start', backgroundColor: 'white', paddingHorizontal: 15 },

    view3: { marginTop: 5, marginBottom: 10 },

    text2: { fontSize: 15, color: colors.grey2 },

    view4: { flexDirection: 'row', borderWidth: 1, borderColor: colors.grey4, borderRadius: 12, paddingLeft: 5 },
    ...
    email: { fontSize: 24, padding: 0, marginBottom: 0, marginTop: 11, marginLeft: 2 },
    ...
    view18: { flex: 1, justifyContent: 'flex-start', alignItems: 'center', paddingTop: 15 },
